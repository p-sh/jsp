...
<body>
	<div class="container">
		<table class="table">
			...
			<tr>
				<th>이름</th>
				<td><input type="text" id="userName" disable></td>
			</tr>
			<tr>
				<th>제목</th>
				<td><input type="text" id="bTitle" disable></td>
			</tr>
			<tr>
				<th>내용</th>
				<td><textarea id="bText" disable></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
...
<script>
	$(document).ready(function(){
		...
		$('#modifyBtn').click(function(){
			...
			$('#bTitle').removeAttr('disalbed', 'false');
			$('#bText').removeAttr('disabled', 'false');
